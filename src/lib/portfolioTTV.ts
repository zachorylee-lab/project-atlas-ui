...
export const portfolioMilestones: PortfolioMilestone[] = [
  ...
  { project: "Wyndham Hotels", dm: "E. Cicero", milestone: "CSM Transition", owner: "E. Cicero → K. Park", date: "Apr 20", daysOut: 31, status: "upcoming", note: "Hypercare exit + ROI readout; requires CSAT ≥ 4.5" },
  ...
  { project: "MetLife", dm: "A. Piggott", milestone: "CSM Transition", owner: "A. Piggott → R. Singh", date: "Apr 5", daysOut: 16, status: "at-risk", note: "Depends on compliance sign-off and CSAT gate" },
  ...
  { project: "Delivery Hero", dm: "S. Pickard", milestone: "CSM Transition", owner: "S. Pickard → J. Vega", date: "Mar 21", daysOut: 1, status: "in-progress", note: "Hypercare exit tomorrow; enablement sign-off complete" },
  ...
  { project: "Canva Pro", dm: "L. Martin", milestone: "Decisioning Studio Enablement", owner: "L. Martin (DM)", date: "Apr 16", daysOut: 27, status: "upcoming", note: "Technical enablement workshop + knowledge check" },
